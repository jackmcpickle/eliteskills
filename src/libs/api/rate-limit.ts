...
export const PAYMENT_SESSION_IP = { max: 5, windowMs: 5 * 60_000 } satisfies RateLimitConfig;
export const PAYMENT_SESSION_KEY = { max: 30, windowMs: 60 * 60_000 } satisfies RateLimitConfig;

/** /api/payment-link — strict (agent creates link) */
export const PAYMENT_LINK_IP = { max: 20, windowMs: 10 * 60_000 } satisfies RateLimitConfig;
export const PAYMENT_LINK_JTI = { max: 10, windowMs: 60 * 60_000 } satisfies RateLimitConfig;
export const PAYMENT_LINK_EMAIL = { max: 5, windowMs: 60 * 60_000 } satisfies RateLimitConfig;

/** /api/create-checkout — public form */
export const CREATE_CHECKOUT_IP = { max: 5, windowMs: 10 * 60_000 } satisfies RateLimitConfig;
export const CREATE_CHECKOUT_EMAIL = { max: 3, windowMs: 60 * 60_000 } satisfies RateLimitConfig;

/** /pay page — defensive */
export const PAY_PAGE_IP = { max: 60, windowMs: 10 * 60_000 } satisfies RateLimitConfig;

/** /api/stripe-webhook — generous but bounded */
export const WEBHOOK_IP = { max: 100, windowMs: 60_000 } satisfies RateLimitConfig;
